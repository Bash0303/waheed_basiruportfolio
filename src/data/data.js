...
import { SiReact, SiTailwindcss, SiCss3, SiJavascript, SiTypescript, SiMicrosoftazure, SiMysql } from "react-icons/si";
...
export const featuresData = {
  frontend: [
    ...
    { id: 5, icon: <SiTailwindcss />, title: "TAILWIND CSS" },
    { id: 6, icon: <FaReact />, title: "REACT JS" },
  ],
  backend: [
    { id: 7, icon: <IoLogoNodejs />, title: "NODE JS" },
    { id: 8, icon: <FaPhp />, title: "PHP" }
  ],
  database: [
    { id: 9, icon: <DiMongodb />, title: "MONGODB" },
    { id: 10, icon: <SiMysql />, title: "MYSQL" }
  ],
  mobile: [
    { id: 11, icon: <SiReact />, title: "REACT NATIVE" }
  ],
  cloud: [
    { id: 12, icon: <CgCloud />, title: "VERCEL" },
    { id: 13, icon: <BsCloudCheck />, title: "RENDER" },
    { id: 14, icon: <SiMicrosoftazure />, title: "AZURE" },
    { id: 15, icon: <FaGithub />, title: "GITHUB" }
  ]
};
...
export const featuresProject = [
  ...
  { id: 7, title: "Ajayi Staff Portal", des: " https://acu-staff-portal-frontend.onrender.com" },
